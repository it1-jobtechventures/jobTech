    ...
    <>
      <main className="justify-center items-center py-5 flex flex-col mt-6">
        ...
        <div ref={ref} className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 align-middle p-1 mt-5">
          <section className="text-2xl text-center bg-[#ffffff69] border text-[#6c6c6c] border-performace-border font-bold h-28 rounded-md flex justify-center items-center flex-col space-y-1 md:space-y-3 w-64 md:w-48 lg:w-56 xl:w-64">
            <p>Jobs Posted</p>
