        ...
        <div className="flex flex-col h-full justify-center space-y-4">
          ...
          <div className="flex space-x-4 mb-4">
            {['who-we-are', 'our-vision', 'our-history'].map((tab) => (
              <button key={tab} className={`px-4 py-2 text-sm font-medium rounded-lg ${activeTab === tab ? 'bg-[#3678f4] text-white shadow-md':'bg-gray-200 text-gray-700 hover:bg-gray-300' }`} onClick={() => handleTabChange(tab)}>
