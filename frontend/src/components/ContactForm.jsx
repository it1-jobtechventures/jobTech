...
//     try {
//       setLoading(true);
//       const response = await axios.post(`${url}/api/form/submit`, formData , token);
//       if (response.data) {
//         sentEmail(formData);
//         setFormData({
//           type: 'general',
...
//         });
//         // if (recaptchaRef.current) {
//         //   recaptchaRef.current.reset(); // Step 3: Reset ReCAPTCHA after submission
//         // }
//       } else {
...
//               </>
//             )}
//             <ReCAPTCHA sitekey={import.meta.env.VITE_RECAPTCHA_SITE_KEY} onChange={onChange} ref={recaptchaRef} />
